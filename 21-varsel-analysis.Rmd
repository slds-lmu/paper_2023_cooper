...
ggsave(plot = p_ppv, filename = "selected-ppv-equallambda.png", path = "selected-plots", width = 16, height = 7)
...
ggsave(plot = p_fpr, filename = "selected-fpr-equallambda.png", path = "selected-plots", width = 16, height = 7)
...
ggsave(plot = p_fpr, filename = "selected-npv-equallambda.pdf", path = "selected-plots", width = 16, height = 7)
ggsave(plot = p_fpr, filename = "selected-npv-equallambda.png", path = "selected-plots", width = 16, height = 7)
