...
ggsave(plot = p_poc, filename = "poc-boxplot-errors.pdf", path = here::here("selected-plots"), width = 10, height = 7)
ggsave(plot = p_poc, filename = "poc-boxplot-errors.png", path = here::here("selected-plots"), width = 10, height = 7)
