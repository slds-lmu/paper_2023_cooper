...
# p_ppv1 <- plot_boxplot_subset(
#   res_long_selected, measure = "PPV", lambda1 > lambda2 & grepl("^B[12]", block))
# 
# ggsave(plot = p_ppv1, filename = "cen-selected-ppv-equallambda-1.pdf", path = "selected-plots", width = 9, height = 5)
# 
# p_ppv2 <- plot_boxplot_subset(
#   res_long_selected, measure = "PPV", lambda1 > lambda2 & grepl("^B[34]", block))
# 
# ggsave(plot = p_ppv2, filename = "cen-selected-ppv-equallambda-2.pdf", path = "selected-plots", width = 9, height = 5)
# 
# p_fpr1 <- plot_boxplot_subset(
#   res_long_selected, measure = "FPR", lambda1 > lambda2)
# 
# p_fpr2 <- plot_boxplot_subset(
#   res_long_selected, measure = "FPR", lambda1 > lambda2)
# 
...
for (measure in c("PPV", "FPR")) {
  #for (blocks in c("^B[12]", "^B[34]")) {
    ...
    ggsave(filename = filename, plot = p, width = 8.5, height = 5)
  #}
}
