...
# result_long_file <- here::here("2-variable-selection-sim/results_long.rds")
...
```{r, include = FALSE}
tmp <- sim_surv_binder(n_train = 10, p = 5000)
...
```{r selected-ppv-difflambda, eval = FALSE}
...
ggsave(plot = p_ppv2, filename = "selected-ppv-difflambda.pdf", path = here::here("selected-plots"), width = 12, height = 4)
ggsave(plot = p_ppv2, filename = "selected-ppv-difflambda.png", path = here::here("selected-plots"), width = 12, height = 4)
```
...
ggsave(plot = p_npv1, filename = "selected-npv-equallambda.pdf", path = "selected-plots", width = 12, height = 4)
ggsave(plot = p_npv1, filename = "selected-npv-equallambda.png", path = "selected-plots", width = 12, height = 4)
```
