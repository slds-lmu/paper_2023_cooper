...
plot_errors_boxplot <- function(res_long, true_effects, problem, z_method = "original", z_scale = 1, iter_max = 2) {
  ...
  res_long |>
    ...
    facet_grid(rows = vars(beta), cols = vars(z_scale, theta), labeller = label_context) +
...
plot_errors_boxplot(
  res_long, true_effects, names(sim_labels), z_scale = c(1, 100), z_method = "original", iter_max = 10
)
