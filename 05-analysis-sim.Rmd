...
plot_errors_boxplot(
  res_long, true_effects, names(sim_labels), z_scale = c(1), iter_max = 5, t = c(1, 50, 100), thresh = c(0)
)

plot_errors_boxplot(res_long, true_effects, "sim_a", z_scale = c(1, 100), iter_max = 1)
plot_errors_boxplot(res_long, true_effects, "sim_a", z_scale = c(1, 100), iter_max = 2)
plot_errors_boxplot(res_long, true_effects, "sim_c", z_scale = c(1, 100), iter_max = 5,  t = c(1, 100), thresh = c(0, 0.001))
```
